...
async function main() {
    ...
    let factoryInstance = new ethers.Contract(factory.address, factory.abi).connect(deployer);
    ...
    console.log(factoryInstance.signer.address, "Factory instance signers address")
    await factoryInstance.deployTracer(deployTracerData, oracle.address, maxLiquidationSlippage)
